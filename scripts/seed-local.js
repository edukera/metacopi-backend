...
/**
 * Script pour exécuter le seeding avec les variables d'environnement locales
...
console.log('Lancement du seeding en environnement local...');
...
tsNode.on('close', (code) => {
  if (code === 0) {
    console.log('Seeding local terminé avec succès ✅');
  } else {
    console.error(`Seeding local échoué avec le code d'erreur ${code} ❌`);
    process.exit(code);
  }
}); 